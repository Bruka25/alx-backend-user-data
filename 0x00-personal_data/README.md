The following python files are for ALX 0x00-personal_data project within the alx-backend-user-data curriculum, inside it contains the following python codes:
